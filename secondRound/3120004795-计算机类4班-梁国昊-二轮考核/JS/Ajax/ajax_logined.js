window.addEventListener('load', function() {
    ...
    let userCookie = window.localStorage.getItem("cookie");
        ...
        // let user_account = defaultUrlHeader_1 + '/user/account' + userCookie;
        // AjaxRequest_msg(user_account);

        // let user_subcount = defaultUrlHeader_1 + '/user/subcount' + userCookie;
        // AjaxRequest_msg(user_subcount);
    ...
    function callback_logined(data) {
        ...
        userDetail.innerHTML = `<img src="${data.profile.avatarUrl}" alt="">
        <div class="user_name">
        ...
        //         // pic.style.zIndex = 1;
        //         // user_container.style.zIndex = 2; 
        //         // clearInterval(user_container.timer)
        //         console.log(h);
        //         setTimeout(function(){
        ...
        //                 }
        //                 h += 25;
        //                 user_select.style.height = h + 'px';
        //             },20);
        //         }, 100);
        // });


        // user_container.addEventListener('mouseleave', function() {
        //     clearInterval(pic.timer);
        //     // user_container.style.zIndex = 1;
        //     // pic.style.zIndex = 2;
        //     setTimeout(function(){
        //         var timer = setInterval(function(callback){
        //         if(h == 0) {
